...
namespace Dexter.Dependency.Castle.Container
{
	...
	/// <summary>
	///     The implementation of <see cref="IDexterContainer" /> using <c>Caslte Windsor</c> container
	///     <seealso
	...
	public class CastleContainer : IDexterContainer
	{
		...
		/// </summary>
		public CastleContainer() : this(new WindsorContainer())
		{
		}
		...
		/// <param name="instance">
		///     The instance of <paramref name="type" /> .
		/// </param>
		...
		/// </summary>
		/// <param name="type"> The type to register. </param>
		/// <param name="implementedBy">
		///     The implementation of <paramref name="type" /> .
		/// </param>
		/// <param name="lifeCycle"> The life cycle. </param>
		/// <remarks>
		///     Singleton should be the default lifecycle.
		...
		/// <typeparam name="TK">
		///     The implementation of the generic type <c>T</c> .
		/// </typeparam>
		/// <param name="instance">
		///     The instance of the generic type <c>TK</c> .
		/// </param>
		/// <param name="lifeCycle"> The life cycle. </param>
		/// <remarks>
		///     Singleton should be the default lifecycle.
		...
		{
			BasedOnDescriptor set = Classes.FromAssembly(assembly)
			                               .BasedOn<T>()
			                               .WithServiceAllInterfaces()
			                               .Unless(cd => cd.IsAbstract);
		...
		/// <returns>
		///     Null if there aren't registered instances for the specified <c>type</c> . Otherwise an array of the generic type <c>T</c> .
		/// </returns>
		...
		/// </summary>
		/// <returns>
		///     Null if there aren't registered instances for the specified <c>type</c> . Otherwise an array of <c>object</c> .
		/// </returns>
